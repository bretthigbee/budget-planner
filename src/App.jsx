...
export default function App() {
  ...
  const S={
    ...
    bnav:    {position:"fixed",bottom:-50,left:0,right:0,background:"#06060B",borderTop:"1px solid rgba(255,255,255,0.06)",display:"flex",justifyContent:"space-around",paddingTop:10,paddingBottom:84,zIndex:50},
